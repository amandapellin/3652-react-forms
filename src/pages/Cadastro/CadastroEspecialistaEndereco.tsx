import { Button, Divisor, ErrorMessage, Fieldset, Form, FormContainer, Input, Label, Titulo, 
          UploadDescription, UploadIcon, UploadInput, UploadLabel, UploadTitulo} from "../../components";
      ...
      <>
        ...
        <Form onSubmit={handleSubmit(aoSubmeter)}>
          <>
            ...
            {errors.endereco?.avatar && <ErrorMessage>{errors.endereco?.avatar?.message}</ErrorMessage>}
          </>
