  ...
  const schemaCadastroEspecialista = z.object({
    ...
    especialidades: z.array(z.object({
      ...
      anoConclusao: z.coerce.number({
        errorMap: () => {
          return {message: "Preencha o ano de conclusão"};
        }
      }).min(4, "Preencha o ano de conclusão"),
      instituicao: z.string().min(1, "Preencha a instituição de formação"),
    }))
  });
            ...
            <div key={field.id}>
              ...
              <FormContainer>
                <Fieldset>
                  ...
                  <ErrorMessage>{errors.especialidades?.[index]?.anoConclusao?.message}</ErrorMessage>
                )}
                </Fieldset>
                <Fieldset>
                  ...
                  <ErrorMessage>{errors.especialidades?.[index]?.instituicao?.message}</ErrorMessage>
                )}
                </Fieldset>
              </FormContainer>
              <Divisor />
